                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            setSelectedNumber(String(Math.floor(Math.random() * 100)).padStart(2, '0'))
                          }}
                ...
                <CardContent className="px-3 py-1">
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex flex-col gap-1 shrink-0">
                      <h3 className="font-extrabold text-sm text-foreground">Pick your Bet Number</h3>
                      <button
                        type="button"
                        onClick={() => setSelectedNumber(String(Math.floor(Math.random() * 36) + 1).padStart(2, '0'))}
                        className="self-start px-2 py-0.5 bg-neutral-900 border border-neutral-800 text-foreground text-[10px] font-bold rounded-md"
                      >
                        Quick Pick
                      </button>
                    </div>
